...
mycodingwritingmenu = {
    {"gvim", "gvim"}, {"code", "code"}, {"libreoffice", "libreoffice"}
}

mycgmenu = {
    {"geeqie", "geeqie"}, {"blender", "blender"}, {"gimp", "gimp"},
    {"inkscape", "inkscape"}, {"mcomix", "mcomix"}
}

myaudiovideomenu = {{"smplayer", "smplayer"}, {"vlc", "vlc"}}
...
mymainmenu = awful.menu({
    items = {
        {"internet", myinternetmenu}, {"coding writing", mycodingwritingmenu},
        {"cg", mycgmenu}, {"audio video", myaudiovideomenu}, {"steam", "steam"},
        {"keepassxc", "keepassxc"}, {"gnucash", "gnucash"}, {"fcitx", "fcitx"},
        {"pavucontrol", "pavucontrol"},
        {"awesome", myawesomemenu, beautiful.awesome_icon},
        {"terminal", terminal}, {"cool-retro-term", "cool-retro-term"},
...
-- {{{ Key bindings
globalkeys = awful.util.table.join(awful.key({modkey}, "s",
